...
SensitivityAnalysis::SensitivityAnalysis( const MWCDModel &model ) :
    QDialog( nullptr ),
    ui( new Ui::SensitivityAnalysis )
{
    ui->setupUi( this );
    ...
    _upMWCDModel.reset( new MWCDModel( model ) );
    _upOrignalModel.reset( new MWCDModel( model ) );
...
void SensitivityAnalysis::on_bt_startSens_clicked()
{
    ...
    _upMWCDModel.reset( new MWCDModel( *_upOrignalModel ) );
    ...
    qDebug() << "Clicked bt_startSens: " << *_upMWCDModel;
